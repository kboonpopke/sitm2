                    ...
                    <div class="card-body">
                        <form action="lbf520f-code.php" method="POST">
                            ...
                            <div class="row g-1">
                                ...
                                <div class="col">
                                    <label>Unit</label>
                                    <input type="text" name="lbf520f_unit_i" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row g-1 mb-3">
                                ...
                                <div class="col">
                                    <label>Unit</label>
                                    <input type="text" name="lbf520f_uniti_r" class="form-control">
                                </div>
                            </div>

                            <div class="mb-3">
                                <label>Status</label>
                                <input type="text" name="lbf520f_status" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>Ramark</label>
