...
<head>
    ...
    <title>PE Shrink 1250ml. - Thaipackaging</title>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-9">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Remaining</div>
                                <?php
$query = "SELECT SUM(shf520p_quantity_r) as total_quantity FROM shf520p"; // Replace shf520p_quantity_r with the actual column name
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>PE Shrink 1250ml. - Thaipackaging
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $shf520p['shf520p_md']; ?></td>
                                    <td><?= $shf520p['shf520p_rd']; ?></td>
